...
清空下蓝牙缓存，同时按住 option 和 shift 键然后点击菜单栏的蓝牙图标会出现“调试”选项。

## Mac 键盘输入温度的°符号

按下「shift + option + 数字 8」键，此方法会输出一个大一点的圆点「°」

## 使用 Pandoc 将 mackdown 项目转换为 epub
...
* [npm 版本怎么降级？](https://segmentfault.com/q/1010000009912057) npm install npm@6.1.0 -g
