...
* Mac OS 编译问题: [BUILD FAILED (OS X 11.0.1 using python-build 20180424)](https://github.com/pyenv/pyenv/issues/1738), 需要在 [apple develop](https://developer.apple.com/download/more/) 下载 Command Line Tools for Xcode 12.3 Release Candidate.
