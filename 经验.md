...
* [BUILD FAILED (OS X 11.0.1 using python-build 20180424)](https://github.com/pyenv/pyenv/issues/1738), 需要在 [apple develop](https://developer.apple.com/download/more/) 下载 Command Line Tools for Xcode 12.3 Release Candidate. 
  * 第二种解决方案: [pyenv installでエラーが発生する](https://medium.com/@bj1024/pyenv-install-error-mac-dcbd28fdc9db).
